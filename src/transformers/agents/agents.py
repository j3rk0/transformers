...
class Agent:
    ...
    def initialize_for_run(self, task: str, **kwargs):
        ...
        if hasattr(self, "authorized_imports"):
            self.system_prompt = format_prompt_with_imports(self.system_prompt, self.authorized_imports)
...
class CodeAgent(Agent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.authorized_imports = LIST_SAFE_MODULES + self.additional_authorized_imports
